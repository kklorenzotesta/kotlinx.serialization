// todo: remove this after update to 1.3.50, where these serializers hardcoded in plugin
@file:UseSerializers(
    ByteArraySerializer::class,
    IntArraySerializer::class,
    BooleanArraySerializer::class,
    CharArraySerializer::class,
